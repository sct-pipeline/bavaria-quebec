...
# sct_deep_seg for non-cropped, but resampled axial images with thick slices using the t2 setting
sct_deepseg_lesion -i ${file}_T2w_res.nii.gz -c t2 -o lesion_t2ax
