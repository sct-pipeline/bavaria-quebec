...
rsync -avzh $PATH_DATA_PROCESSED/derivatives/labels/${SUBJECT}/anat/${file_gt}_res.nii.gz $PATH_DATA_PROCESSED_CLEAN/derivatives/sct-5.8-isotropic/labels/${SUBJECT}/anat/${file_gt}.nii.gz
...
rsync -avzh $PATH_DATA_PROCESSED/${SUBJECT}/anat/lesion_t2ax/${file}_T2w_res_lesionseg.nii.gz $PATH_DATA_PROCESSED_CLEAN/derivatives/sct-5.8-isotropic/labels/${SUBJECT}/anat/${file}_lesion-processed_T2w.nii.gz
